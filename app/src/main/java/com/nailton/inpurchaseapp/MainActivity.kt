package com.nailton.inpurchaseapp
...
import com.nailton.inpurchaseapp.helper.PurchaseHelper
import com.nailton.inpurchaseapp.ui.theme.InPurchaseAppTheme
...
fun MainScreen(purchaseHelper: PurchaseHelper) {
    ...
    Column(
        ...
        Row(
            ...
            Button(
                onClick = { purchaseHelper.consumerPurchase() },
                modifier = Modifier.padding(20.dp),
